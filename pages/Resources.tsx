    ...
    <div className="bg-brand-50 min-h-screen">
          ...
          {BLOG_POSTS.map((post) => (
            <div key={post.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow">
               ...
               <div className="p-6">
                 ...
                 <h3 className="font-bold text-lg text-stone-800 mb-2 hover:text-brand-700 cursor-pointer">{post.title}</h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-center text-stone-500 mb-12">Everything you need to know about booking with us.</p>
        ...
        <div className="bg-stone-100 rounded-xl p-8 border border-stone-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-stone-700">
            ...
            <div>
              ...
              <p className="mb-4">
                In the event of a medical emergency, we will attempt to contact you and your vet immediately. If unavailable, we reserve the right to seek care at the nearest animal hospital.
              </p>
              <h3 className="font-bold text-brand-800 mb-2">Keys & Access</h3>
              <p>
                We require two forms of entry (e.g., key and code) or a lockbox. Keys are kept in a secure, non-labeled safe when not in use.
              </p>
            </div>
          </div>
        </div>
